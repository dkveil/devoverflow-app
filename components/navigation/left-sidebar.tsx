      ...
      <div className="flex flex-col gap-3">
        {userId
          ? (
              ...
              >
                <Button type="submit" className="small-medium btn-secondary min-h-[41px] w-full rounded-lg px-4 py-3 shadow-none">
                  <LogOut className="size-5 text-black dark:text-white" />
                  <span className="text-dark300_light700 max-lg:hidden">Logout</span>
                </Button>
              </form>
            )
          : (
