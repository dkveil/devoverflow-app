...
export async function singUpWithCredentials(params: AuthCredentials): Promise<ActionResponse> {
...
export async function singInWithCredentials(params: Pick<AuthCredentials, 'email' | 'password'>): Promise<ActionResponse> {
